...
const char* topico = "topicoSensores";
...
void connect_MQTT(IPAddress mqtt_server, int mqtt_port, PubSubClient *mqttClient, const char *topico);
...
void setup() {
  ...
  connect_MQTT(mqtt_server, mqtt_port, &mqttClient, topico); // Estabelece conexão com o Broker MQTT e faz o SUBSCRIBE dos tópicos
}
